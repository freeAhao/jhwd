...
#====================================================================
    ...
    def autoshiftscope_add_item(self,imgpath,data):
        self.autoshiftscope.addItem(QIcon(imgpath), data,userData=data)

    def toggle_autoshiftscope_display(self,display:bool):
        if display:
            self.autoshift.show()
            self.autoshiftscope.show()
        else:
            self.autoshift.hide()
            self.autoshiftscope.hide()
